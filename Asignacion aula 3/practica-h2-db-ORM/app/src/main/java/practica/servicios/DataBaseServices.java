...
public class DataBaseServices {
    ...
    private String URL = "jdbc:h2:file:C:/Users/Bryant Reynoso/Desktop/Programacion web - Javalin/MyH2DB"; //Modo Server...
...
public static DataBaseServices getInstancia(){
  ...
  private void registrarDriver() {
      try {
          Class.forName("org.h2.Driver");} catch (ClassNotFoundException ex) {
